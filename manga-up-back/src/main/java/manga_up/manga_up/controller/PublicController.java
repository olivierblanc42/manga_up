...
public class PublicController {
    ...
    public PublicController(MangaService mangaService, AuthorService authorService, GenreService genreService,
            CategoryService categoryService, GenreUserService genderUserService) {
